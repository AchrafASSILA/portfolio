...
<html lang="en">
  <head>
    ...
    <title>Achraf Assila</title>
    <meta content="" name="description" />
    <meta content="" name="keywords" />

    <!-- Favicons -->
    {{-- <link href="assets/img/fkavicon.png" rel="icon" />
  ...
  <body>
    ...
    <header id="header">
      <div class="d-flex flex-column">
        <div class="profile">
          <img
            src="assets/img/achraf assila.jpg"
            alt=""
            class="img-fluid rounded-circle"
          />
          <h1 class="text-light"><a href="index.html">Achraf Assila</a></h1>
          <div class="social-links mt-3 text-center">
            <a target="_blank" href="https://github.com/AchrafASSILA" class="github"><i class="bx bxl-github"></i></a>
            <a target="_blank" href="https://www.instagram.com/achraf_essl/" class="instagram"><i class="bx bxl-instagram"></i></a>
            <a target="_blank" href="https://www.linkedin.com/in/achraf-assila-94448321a/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
          </div>
        </div>
    ...
    >
      <div class="hero-container" data-aos="fade-in">
        ...
        <p>
          ...
          <span
            class="typed"
            data-typed-items="Back End Developer, Freelancer, Analyzer"
          ></span>
        </p>
      </div>
    </section>
...
<strong>my intro</strong>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
              <h3 style="margin-top: 45px;margin-bottom: -25px;">Full Web Stack Developer</h3>
              <p style="margin-top: 40px;line-height: 1.7;">
                I am ASSILA ACHRAF, 20 years old, a developer
                Creative and competent Web, I have the ability to work
              ...
              <p style="line-height: 1.7;">
                I am a specialist
                in HTML and CSS, Javascript, PHP , LARAVEL
                and MySQL. Moreover, I am innovative, a decision-maker
                solid and I have excellent skills in
                communication.
              </p>
            </div>
          </div>
...
<strong>Our Facts</strong>
        ...
        <div class="container">
          ...
          <div class="row skills-content">
            <div class="col-lg-6" data-aos="fade-up">
              ...
              <div class="progress">
                <span class="skill">JavaScript <i class="val">93%</i></span>
                <div class="progress-bar-wrap">
                  <div
                    class="progress-bar"
                    role="progressbar"
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="progress">
                <span class="skill">Laravel <i class="val">93%</i></span>
                <div class="progress-bar-wrap">
                  <div
                    class="progress-bar"
                    role="progressbar"
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            >
              ...
              <p class="description">
                high level web application with high level security
              </p>
            </div>
            <div
              class="col-lg-4 col-md-6 icon-box"
            ...
            >
              ...
              <h4 class="title"><a href="">Conception</a></h4>
              <p class="description">
                design systems with good performance and scalability
              </p>
            </div>
      ...
      <section id="testimonials" class="testimonials section-bg">
        <div class="container">
          <div class="section-title">
            <h2>Testimonials</h2>
            <p>
             <strong> What my supervisor says about me ?</strong> </p>
          </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="testimonial-item" data-aos="fade-up">
                  <p>
                    ...
                    A good team player and plays an important role  
              ...
              <div class="swiper-slide">
                ...
                >
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    he loves challanges and  well disciplined 
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                  <img
              ...
              <div class="swiper-slide">
                ...
                >
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    hard working and Passionate at  what he does
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                  <img
              ...
              <div class="swiper-slide">
                ...
                >
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    grate kid with good potentials at logical thinking
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                  <img
      ...
      <section id="contact" class="contact">
        <div class="container">
          <div class="section-title">
            <h2>Contact</h2>
            <p>
              <strong>Have a Project ? </strong> make your idea real by contacting me
            </p>
          </div>
    ...
    <footer id="footer">
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>Achraf Assila</span></strong>
        </div>
